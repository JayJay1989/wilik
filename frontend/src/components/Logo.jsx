function Logo({ size = 32 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24">
      ...
      <path d="M12 9c-1.8-2.8-5.2-4.4-6.8-2.7-1.2 1.3.1 3.4 2.3 3.4.9 0 3-.2 4.5-.7z" fill="var(--text-h)" />
      <path d="M12 9c1.8-2.8 5.2-4.4 6.8-2.7 1.2 1.3-.1 3.4-2.3 3.4-.9 0-3-.2-4.5-.7z" fill="var(--text-h)" />
